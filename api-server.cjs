...
// TEMPORARY — playground data for testing the review app while Claude API access is down
// (queue-processor.cjs's extraction step can't run, but nothing downstream of "Ready for
// Review" needs Claude). Appends fake rows straight into the Queue sheet at that status,
// skipping extraction entirely. Remove this endpoint once seeding is done — it's a one-off,
// not something that should stay live.
const TEST_QUEUE_ROWS = [
  { title: 'TEST — Junior Costume Assistant', type: 'Opportunity', deadline: '2026-07-29', industry: 'Fashion, Theatre', location: 'London', desc: 'Support the costume department on a touring theatre production, from fittings to on-the-day repairs backstage.', demo: 'catch-all' },
  { title: 'TEST — Indie Game Dev Meetup', type: 'Event', deadline: '2026-07-30', industry: 'Gaming, Tech', location: 'Manchester', desc: 'A monthly meetup for indie developers to show work-in-progress builds and swap feedback over pizza.', demo: 'blank' },
  { title: 'TEST — Intro to Sound Design', type: 'Course', deadline: '2026-08-01', industry: 'Music, Film & TV', location: 'Remote', desc: 'A four-week evening course covering foyer basics of sound design for film, from foley to mixing.', demo: 'catch-all' },
  { title: 'TEST — Social Content Creator', type: 'Opportunity', deadline: '', industry: 'Marketing, Design', location: 'Remote / UK Wide', desc: 'Create short-form video content for a growing lifestyle brand across TikTok and Instagram.', demo: 'blank' },
  { title: 'TEST — Junior Set Designer Apprenticeship', type: 'Apprenticeship', deadline: '2026-08-03', industry: 'Theatre & Performing Arts', location: 'Bristol', desc: 'A year-long apprenticeship building and painting sets for a regional theatre company’s main stage seasons.', demo: 'catch-all' },
  { title: 'TEST — Marketing Internship, Fashion Label', type: 'Internship', deadline: '2026-08-05', industry: 'Fashion, Marketing & Advertising', location: 'London', desc: 'Six-week paid internship supporting campaign planning and social scheduling for an emerging fashion label.', demo: 'blank' },
  { title: 'TEST — Short Film Grant 2026', type: 'Competition/Grant', deadline: '2026-08-07', industry: 'Film & TV', location: 'Nationwide (UK Wide)', desc: 'A production grant of up to £2,500 for first-time directors making a short film under 15 minutes.', demo: 'catch-all' },
  { title: 'TEST — Freelance Illustrator Needed', type: 'Freelance role', deadline: '2026-08-09', industry: 'Illustration, Publishing', location: 'Remote', desc: 'A children\'s publisher is looking for a freelance illustrator for a 32-page picture book, delivery in 10 weeks.', demo: 'blank' },
  { title: 'TEST — Junior Full-Time Editor', type: 'Junior full-time role', deadline: '2026-08-11', industry: 'Film & TV', location: 'Leeds', desc: 'Unclear', demo: 'catch-all' },
  { title: 'TEST — Creative Mentoring Programme', type: 'Mentoring', deadline: '2026-08-12', industry: 'Design, Marketing & Advertising', location: 'Glasgow', desc: 'Six months of one-to-one mentoring pairing early-career creatives with senior industry practitioners.', demo: 'blank' },
  { title: 'TEST — Theatre Work Experience Week', type: 'Work experience', deadline: '2026-08-20', industry: 'Theatre & Performing Arts', location: 'Birmingham', desc: 'A week shadowing front-of-house, technical, and production teams at a mid-scale regional theatre.', demo: 'catch-all' },
  { title: 'TEST — Runner, Music Video Shoot', type: 'Runner role', deadline: '2026-08-25', industry: 'Music, Film & TV', location: 'London', desc: 'Paid runner role on a two-day music video shoot — general set support and errands for the production team.', demo: 'blank' },
  { title: 'TEST — Publishing Training Scheme', type: 'Training scheme', deadline: '2026-09-05', industry: 'Publishing', location: 'London', desc: 'An 18-month rotational training scheme across editorial, rights, and marketing at an independent publisher.', demo: 'catch-all' },
  { title: 'TEST — Junior Part-Time Gallery Assistant', type: 'Junior part-time role', deadline: '2026-09-15', industry: 'Design, Photography', location: 'Bristol', desc: 'Part-time gallery assistant role (3 days/week) covering front desk, install support, and visitor engagement.', demo: 'blank' },
  { title: 'TEST — Games Design Open Day', type: 'Event', deadline: '2026-09-25', industry: 'Gaming, Tech', location: 'Online', desc: 'An open day for aspiring games designers featuring studio talks, portfolio reviews, and a Q&A panel.', demo: 'catch-all' },
  { title: 'TEST — Photography Fundamentals', type: 'Course', deadline: '2026-10-10', industry: 'Photography', location: 'Manchester', desc: 'A weekend course covering camera fundamentals, lighting, and composition for aspiring photographers.', demo: 'blank' },
  { title: 'TEST — Animation Apprenticeship 2027', type: 'Apprenticeship', deadline: '2026-11-01', industry: 'Animation, Film & TV', location: 'London', desc: 'A two-year apprenticeship at an animation studio, rotating through storyboarding, rigging, and compositing.', demo: 'catch-all' },
  { title: 'TEST — Junior Video Editor Internship', type: 'Internship', deadline: '2026-12-01', industry: 'Film & TV, Marketing', location: 'Remote', desc: 'Three-month internship editing short-form video content for a digital media company’s social channels.', demo: 'blank' },
];
...
app.post('/admin/seed-test-queue-rows', async (req, res) => {
  try {
    const sheets = getSheetsClient();
    const rows = TEST_QUEUE_ROWS.map(r => [
      'Ready for Review',
      '',
      r.industry,
      r.type,
      r.deadline,
      'https://example.com/' + r.title.toLowerCase().replace(/[^a-z0-9]+/g, '-'),
      r.location,
      '',
      r.title,
      r.desc,
      r.demo === 'catch-all' ? CATCH_ALL_DEMOGRAPHICS : '',
      '',
      '',
    ]);
