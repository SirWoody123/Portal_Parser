...
const TAG_NAME_TO_ID = {
  // --- INDUSTRIES (real Firestore tag IDs) ---
  ...
  "Directing (alt)": "rfG4zhlDhcfjE4DMA6rD",
  ...
  "Social Media (alt)": "2YMJoKoU41yC7sCleDnd",
  "Content creation": "ajxlsmbwodNP5FfVPbvf",
  "Digital Media": "MyNQqi1cxSKxDzTFIUD1",
  "Digital Media (alt)": "g5n1GEPWYv8JqenX22T2",
  ...
  "Photography (alt)": "ZEtRdZGb5YmvbtjniiBI",
  "Videography": "GjC6ilPu74QiVYRvRvgg",
  "Publishing": "ybNc8iJxaoo7TjoJyl71",
  "Publishing (alt)": "njID4Zd7PpqArqUnCERh",
  "Writing": "OWX5xMlENH8zEqL6ZJzI",
  "Writing (alt)": "8PawTwYxdWzCJem74oS3",
